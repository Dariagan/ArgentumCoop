...
//get_node("/root/MyAutoloadName"); USAR get_node para acceder a un nodo específico directamente (útil par acceder al argentum tilemap)
...
private:
    ...
    std::unique_ptr<matrix<u_int16_t>> mBeingsInChunkCount = nullptr;
