...
// {//NO DEFINIR ¡NUNCA! CUERPOS DE MÉTODOS EN LOS HEADER FILES (AUNQUE ESTÉN VACÍOS). SIEMPRE CAUSAN PROBLEMAS DE LINKING AL COMPILAR POR NO ENCONTRAR DEFINICIONES 
