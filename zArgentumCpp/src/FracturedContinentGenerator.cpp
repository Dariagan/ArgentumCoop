...
double FracturedContinentGenerator::get_continental_cutoff()const{return mContinentalCutoff;}
void FracturedContinentGenerator::set_continental_cutoff(double cutoff){mContinentalCutoff = cutoff;} 
